...
* We introduced the new selection property for the [Pluggable Widgets API](/apidocs-mxsdk/apidocs/pluggable-widgets/) which allows widgets to read and set selections that can be used in actions, expressions, or a **Listen to** data source of a data view.
